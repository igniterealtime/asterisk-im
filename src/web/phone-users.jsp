<%@ page import="org.jivesoftware.admin.AdminPageBean,
                 ...
                 org.jivesoftware.phone.PhoneUser,
                 org.jivesoftware.phone.PhoneManager,
                 org.jivesoftware.phone.PhoneManagerFactory,
                 java.util.Collection,
                 org.jivesoftware.util.ParamUtils,
                 java.util.HashMap,
                 org.jivesoftware.phone.PhoneDevice,
...
- Users per Page:
<select size="1" onchange="location.href='phone-users.jsp?start=0&range=' + this.options[this.selectedIndex].value;">
...
<tbody>
    ...
    <tr valign="top">
        ...
        <td width="99%" >
            ...
            <% } else { %>
                <input type="text" name="device" size="35" value="<%= device != null ? device : ""%>" id="devicetf"/>
            <% } %>
    ...
    <tr valign="top">
        ...
        <td width="99%" >
            <input type="text" name="extension" size="35" value="<%= extension != null ? extension : ""%>" id="extensiontf"/>
    ...
    <tr valign="top">
        ...
        <td width="99%" >
            <input type="text" name="callerID" size="35" value="<%= callerID != null ? callerID : ""%>" id="callerIDtf"/>
